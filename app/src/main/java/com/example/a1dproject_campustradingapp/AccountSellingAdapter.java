...
public class AccountSellingAdapter extends RecyclerView.Adapter<AccountSellingAdapter.ImageViewHolder> {

    private Context mContext;
    private List<Upload> mUploads;
    private OnItemClickListener mListener;

    public AccountSellingAdapter(Context context, List<Upload> uploads){
        mContext = context;
        mUploads = uploads;
    }
    ...
    @NonNull
    @Override
    public AccountSellingAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.image_item, parent, false);
        return new AccountSellingAdapter.ImageViewHolder(v);
    }
